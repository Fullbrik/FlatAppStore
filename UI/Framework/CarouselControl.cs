...
namespace FlatAppStore.UI.Framework
{
	public class CarouselControl : UserControl, IFocusLayoutProvider
	{
		...
		protected override Control Build()
		{
			...
			carouselPartsLayout.AddChild(new UI.Controls.TestFocusControl(Color.BROWN));
			carouselPartsLayout.AddChild(new SpacerControl(10, 0));
			carouselPartsLayout.AddChild(new UI.Controls.TestFocusControl(Color.ORANGE));
			carouselPartsLayout.AddChild(new SpacerControl(10, 0));
			carouselPartsLayout.AddChild(new UI.Controls.TestFocusControl(Color.BLUE));
			carouselPartsLayout.AddChild(new SpacerControl(10, 0));
			carouselPartsLayout.AddChild(new UI.Controls.TestFocusControl(Color.DARKPURPLE));
			carouselPartsLayout.AddChild(new SpacerControl(20, 0));
