    ...
    public class LabelControl : Control
    {
        ...
        public override Vector2 GetSize(Vector2 maxSize)
        {
            System.Console.WriteLine(
                "Label FontSize: {0}, size X: {1}, Y: {2}",
                FontSize,
                Raylib.MeasureTextEx(Raylib.GetFontDefault(), localizedText, FontSize, FontSize / 10).X,
                Raylib.MeasureTextEx(Raylib.GetFontDefault(), localizedText, FontSize, FontSize / 10).Y);
