...
namespace FlatAppStore.UI.Framework
{
	...
	public class ScrollLayoutControl : LayoutControl
	{
		...
		protected override Vector2 LayoutChildrenAndGetSize(Vector2 maxSize)
		{
			...
			MaxHorizontalScroll = (int)(currentWidth - maxSize.X); // Ensure we can't scroll to the point where the scroll goes past the parent
			MaxVerticalScroll = (int)(currentHeight - maxSize.Y);
